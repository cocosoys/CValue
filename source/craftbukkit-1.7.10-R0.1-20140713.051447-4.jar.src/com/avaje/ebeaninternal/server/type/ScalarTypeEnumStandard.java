...
/* 236 */       super((Class)type, jdbcNative, jdbcType);
...
/* 245 */       return t.toString();
/*     */     }
/*     */     
/*     */     public Object parse(String value) {
/* 249 */       return Enum.valueOf(this.enumType, value);
/*     */     }
/*     */     
/*     */     public Object parseDateTime(long systemTimeMillis) {
/* 253 */       throw new TextException("Not Supported");
/*     */     }
/*     */     
...
/* 262 */       return parse(value);
/*     */     }
/*     */ 
/*     */     
/*     */     public String jsonToString(Object value, JsonValueAdapter ctx) {
/* 267 */       return EscapeJson.escapeQuote(value.toString());
/*     */     }
/*     */     
...
/* 275 */       return parse((String)value);
/*     */     }
/*     */     
/*     */     public Object luceneToIndexValue(Object value) {
/* 279 */       return format(value);
/*     */     }
/*     */     
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\type\ScalarTypeEnumStandard.class
