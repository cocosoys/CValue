...
/*     */     
/* 118 */     ArrayList<Object> idList = new ArrayList(batchSize);
/*     */     
/* 120 */     for (int i = 0; i < batch.size(); i++) {
/* 121 */       BeanCollection<?> bc = batch.get(i);
...
/*     */     }
/*     */     
/* 162 */     this.server.findList((Query<?>)query, loadRequest.getTransaction());
/*     */ 
/*     */ 
/*     */     
/* 166 */     for (int j = 0; j < batch.size(); j++) {
/* 167 */       if (((BeanCollection)batch.get(j)).checkEmptyLazyLoad() && 
...
/* 201 */     loadManyInternal(parentBean, propertyName, t, true, null, false);
/*     */   }
/*     */   
...
/* 209 */     PersistenceContext pc = null;
...
/* 215 */       pc = ebi.getPersistenceContext();
/*     */     } 
/*     */     
...
/* 268 */     query.setPersistenceContext((PersistenceContext)defaultPersistenceContext);
...
/*     */     }
/*     */     
/* 279 */     this.server.findUnique((Query<?>)query, t);
/*     */     
...
/*     */     
/* 310 */     EntityBeanIntercept[] ebis = batch.<EntityBeanIntercept>toArray(new EntityBeanIntercept[batch.size()]);
/* 311 */     ArrayList<Object> idList = new ArrayList(batchSize);
/*     */     
/* 313 */     for (int i = 0; i < batch.size(); i++) {
...
/*     */ 
/*     */     
/* 332 */     for (int j = 0; j < ebis.length; j++) {
/* 333 */       Object parentBean = ebis[j].getParentBean();
...
/*     */     } 
/*     */     
/* 360 */     List<?> list = this.server.findList((Query<?>)query, loadRequest.getTransaction());
/*     */     
/* 362 */     if (desc.calculateUseCache(null)) {
/* 363 */       for (int k = 0; k < list.size(); k++) {
/* 364 */         desc.cachePutObject(list.get(k));
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   public void refresh(Object bean) {
/* 370 */     refreshBeanInternal(bean, SpiQuery.Mode.REFRESH_BEAN);
/*     */   }
/*     */   
/*     */   public void loadBean(EntityBeanIntercept ebi) {
/* 374 */     refreshBeanInternal(ebi.getOwner(), SpiQuery.Mode.LAZYLOAD_BEAN);
/*     */   }
/*     */   
...
/* 382 */     PersistenceContext pc = null;
/*     */     
/* 384 */     if (!vanilla) {
/* 385 */       ebi = ((EntityBean)bean)._ebean_getIntercept();
/* 386 */       pc = ebi.getPersistenceContext();
/*     */     } 
/*     */     
...
/* 396 */       if (ebi != null) {
/* 397 */         ebi.setPersistenceContext((PersistenceContext)defaultPersistenceContext);
/*     */       }
/*     */     } 
/*     */     
...
/* 426 */     query.setPersistenceContext((PersistenceContext)defaultPersistenceContext);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\core\DefaultBeanLoader.class
