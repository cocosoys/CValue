...
/* 104 */       return (DatabasePlatform)new MySqlPlatform();
/*     */     }
/* 106 */     if (dbName.equals("sqlite")) {
/* 107 */       return (DatabasePlatform)new SQLitePlatform();
/*     */     }
/*     */     
...
/* 135 */         logger.log(Level.SEVERE, (String)null, ex);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 152 */         return (DatabasePlatform)new Oracle10Platform();
/*     */       }
/* 154 */       return (DatabasePlatform)new Oracle9Platform();
/*     */     } 
/*     */     
/* 157 */     if (dbProductName.indexOf("microsoft") > -1) {
/* 158 */       if (majorVersion > 8) {
/* 159 */         return (DatabasePlatform)new MsSqlServer2005Platform();
/*     */       }
/* 161 */       return (DatabasePlatform)new MsSqlServer2000Platform();
/*     */     } 
/*     */ 
/*     */     
/* 165 */     if (dbProductName.indexOf("mysql") > -1) {
/* 166 */       return (DatabasePlatform)new MySqlPlatform();
/*     */     }
/* 168 */     if (dbProductName.indexOf("h2") > -1) {
/* 169 */       return (DatabasePlatform)new H2Platform();
/*     */     }
/* 171 */     if (dbProductName.indexOf("hsql database engine") > -1) {
/* 172 */       return (DatabasePlatform)new HsqldbPlatform();
/*     */     }
/* 174 */     if (dbProductName.indexOf("postgres") > -1) {
/* 175 */       return (DatabasePlatform)new PostgresPlatform();
/*     */     }
/* 177 */     if (dbProductName.indexOf("sqlite") > -1) {
/* 178 */       return (DatabasePlatform)new SQLitePlatform();
/*     */     }
/*     */     
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\core\DatabasePlatformFactory.class
