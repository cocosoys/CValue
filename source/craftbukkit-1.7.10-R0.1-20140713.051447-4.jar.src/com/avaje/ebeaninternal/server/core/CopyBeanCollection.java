...
/*    */     }
/* 85 */     return (BeanCollection<T>)newSet;
/*    */   }
/*    */ 
/*    */   
/*    */   private BeanCollection<T> copyMap() {
/* 90 */     BeanMap<Object, T> newMap = new BeanMap();
...
/* 94 */       Map.Entry<Object, T> entry = iterator.next();
/* 95 */       newMap.put(entry.getKey(), this.desc.createCopy(entry.getValue(), this.ctx, this.maxDepth));
/*    */     } 
/* 97 */     return (BeanCollection)newMap;
/*    */   }
/*    */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\core\CopyBeanCollection.class
