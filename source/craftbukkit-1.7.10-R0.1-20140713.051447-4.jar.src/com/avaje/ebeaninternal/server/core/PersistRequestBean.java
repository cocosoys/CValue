...
/* 177 */       this.oldValues = (T)this.intercept.getOldValues();
...
/* 210 */     return (this.notifyCache || isNotifyPersistListener() || this.beanDescriptor.isNotifyLucene(txnEvent));
/*     */   }
/*     */   
/*     */   public boolean isNotifyCache() {
/* 214 */     return this.notifyCache;
/*     */   }
/*     */   
/*     */   public boolean isNotifyPersistListener() {
/* 218 */     return (this.beanPersistListener != null);
/*     */   }
/*     */   
...
/* 233 */     this.transaction.getEvent().pauseIndexInvalidate(this.beanDescriptor.getBeanType());
/*     */   }
/*     */   
/*     */   public void resumeIndexInvalidate() {
/* 237 */     this.transaction.getEvent().resumeIndexInvalidate(this.beanDescriptor.getBeanType());
/*     */   }
/*     */ 
/*     */   
/*     */   public void addToPersistMap(BeanPersistIdMap beanPersistMap) {
/* 242 */     beanPersistMap.add(this.beanDescriptor, this.type, this.idValue);
/*     */   }
/*     */   
...
/* 325 */     this.transaction.registerBean(getBeanHash());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 332 */     this.transaction.unregisterBean(getBeanHash());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 370 */     return this.beanDescriptor;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 377 */     return this.statelessUpdate;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 385 */     return this.deleteMissingChildren;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 393 */     return this.updateNullProperties;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 422 */     return this.concurrencyMode;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 448 */     return this.beanDescriptor.getFullName();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 462 */     return this.beanDescriptor.getId(this.bean);
/*     */   }
/*     */   
/*     */   public BeanDelta createDeltaBean() {
/* 466 */     return new BeanDelta(this.beanDescriptor, getBeanId());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 693 */     return ((!this.vanilla && this.beanDescriptor.isUpdateChangesOnly()) || this.loadedProps != null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 728 */     return this.changedProps.contains(prop.getName());
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\core\PersistRequestBean.class
