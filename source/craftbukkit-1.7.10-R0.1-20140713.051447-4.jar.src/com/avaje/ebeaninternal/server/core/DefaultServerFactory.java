...
/*     */   
/*  74 */   private final AtomicInteger serverId = new AtomicInteger(1);
/*     */   
...
/*  82 */     this.clusterManager = new ClusterManager();
/*  83 */     this.jndiDataSourceFactory = new JndiDataSourceLookup();
/*     */     
...
/* 113 */     this.clusterManager.shutdown();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 293 */     ServerCacheFactory cacheFactory = null;
/* 294 */     if (cacheFactory == null) {
/* 295 */       defaultServerCacheFactory = new DefaultServerCacheFactory();
/*     */     }
/*     */     
/* 298 */     return (ServerCacheManager)new DefaultServerCacheManager((ServerCacheFactory)defaultServerCacheFactory, beanOptions, queryOptions);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 342 */     server.getDdlGenerator().execute(online);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 351 */       config.setNamingConvention((NamingConvention)nc);
/*     */       
...
/*     */     } 
/*     */     
/* 427 */     return (DataSource)DataSourceGlobalManager.getDataSource(config.getName(), dsConfig);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 485 */           logger.log(Level.SEVERE, (String)null, ex);
/*     */         } 
/*     */       }
/*     */     } 
/*     */   }
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\core\DefaultServerFactory.class
