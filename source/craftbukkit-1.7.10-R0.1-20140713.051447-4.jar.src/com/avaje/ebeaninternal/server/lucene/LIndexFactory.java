...
/*  50 */     return (new Factory(indexDefn, descriptor, this.manager, defaultAnalyzer)).create();
/*     */   }
/*     */ 
/*     */   
...
/*  80 */         IndexFieldDefn fieldDefn = fields.get(i);
...
/*     */         }
/*     */         
/* 134 */         FieldFactory fieldFactory1 = FieldFactory.normal(fieldName, store, index, boost);
/* 135 */         return new LIndexFieldStringConcat(queryAnalyzer, fieldName, fieldFactory1, props, indexAnalyzer);
/*     */       } 
/*     */       
...
/* 145 */         FieldFactory fieldFactory1 = FieldFactory.normal(fieldName, store, index, boost);
/* 146 */         return new LIndexFieldId(queryAnalyzer, fieldName, fieldFactory1, prop, idBinder);
/*     */       } 
/*     */       
/* 149 */       if (luceneType == 7) {
/* 150 */         FieldFactory fieldFactory1 = FieldFactory.normal(fieldName, store, index, boost);
/* 151 */         return new LIndexFieldBinary(queryAnalyzer, fieldName, fieldFactory1, prop);
/*     */       } 
/* 153 */       if (luceneType == 0) {
/* 154 */         FieldFactory fieldFactory1 = FieldFactory.normal(fieldName, store, index, boost);
/* 155 */         return new LIndexFieldString(queryAnalyzer, fieldName, fieldFactory1, prop, indexAnalyzer);
/*     */       } 
/*     */ 
/*     */       
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lucene\LIndexFactory.class
