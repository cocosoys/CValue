...
/*  45 */   private final LinkedHashMap<String, IndexFieldDefn> fieldDefnMap = new LinkedHashMap<String, IndexFieldDefn>();
/*     */   
...
/*  66 */     while (it.hasNext()) {
/*  67 */       BeanProperty beanProperty = it.next();
...
/* 155 */     return this.fieldDefnMap.get(fieldName);
/*     */   }
/*     */   
/*     */   private boolean isLuceneString(int luceneType) {
/* 159 */     return (0 == luceneType);
/*     */   }
/*     */   
...
/* 213 */         BeanProperty beanProperty = it.next();
...
/*     */     
/*     */     public IndexFieldDefn addField(String propertyName) {
/* 232 */       return addField(propertyName, null);
/*     */     }
/*     */     
/*     */     public IndexFieldDefn addField(String propertyName, IndexFieldDefn.Sortable sortable) {
/* 236 */       return addField(propertyName, null, null, sortable);
/*     */     }
/*     */     
/*     */     public IndexFieldDefn addField(String propertyName, Field.Store store, Field.Index index, IndexFieldDefn.Sortable sortable) {
/* 240 */       return this.parent.addPrefixField(this.path, propertyName, store, index, sortable);
/*     */     }
/*     */     
/*     */     public IndexFieldDefn addFieldConcat(String fieldName, String... propertyNames) {
/* 244 */       return addFieldConcat(fieldName, Field.Store.NO, Field.Index.ANALYZED, propertyNames);
/*     */     }
/*     */     
/*     */     public IndexFieldDefn addFieldConcat(String fieldName, Field.Store store, Field.Index index, String... propertyNames) {
/* 248 */       return this.parent.addPrefixFieldConcat(this.path, fieldName, store, index, propertyNames);
/*     */     }
/*     */ 
/*     */     
/*     */     public IndexFieldDefn addPrefixFieldConcat(String prefix, String fieldName, Field.Store store, Field.Index index, String[] propertyNames) {
...
/*     */     
/*     */     public IndexFieldDefn getField(String fieldName) {
/* 263 */       return this.parent.getField(fieldName);
/*     */     }
/*     */     
/*     */     public List<IndexFieldDefn> getFields() {
/* 267 */       return this.parent.getFields();
/*     */     }
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lucene\LIndexFieldsBuilder.class
