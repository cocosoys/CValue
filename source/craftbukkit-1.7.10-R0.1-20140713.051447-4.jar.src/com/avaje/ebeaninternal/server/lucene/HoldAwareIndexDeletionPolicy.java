...
/*     */   
/*  35 */   private final Map<Long, CommitRefCount> commitRefCounts = new HashMap<Long, CommitRefCount>();
/*     */   
...
/*     */       
/*  59 */       this.lastCommit = commits.get(size - 1);
/*     */ 
/*     */       
/*  62 */       for (int i = 0; i < size - 1; i++) {
/*  63 */         IndexCommit indexCommit = commits.get(i);
...
/* 116 */     CommitRefCount refCount = this.commitRefCounts.get(commitVersion);
/* 117 */     if (refCount == null) {
/* 118 */       refCount = new CommitRefCount();
...
/* 131 */       CommitRefCount refCount = this.commitRefCounts.get(commitVersion);
...
/* 147 */       CommitRefCount refCount = this.commitRefCounts.get(commitVersion);
...
/* 159 */       CommitRefCount refCount = this.commitRefCounts.get(commitVersion);
...
/*     */     
/*     */     public int dec() {
/* 177 */       return --this.refCount;
/*     */     }
/*     */     
/*     */     public void touch() {
/* 181 */       this.lastTouched = System.currentTimeMillis();
/*     */     }
/*     */     
/*     */     public long getLastTouched() {
/* 185 */       return this.lastTouched;
/*     */     }
/*     */     
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lucene\HoldAwareIndexDeletionPolicy.class
