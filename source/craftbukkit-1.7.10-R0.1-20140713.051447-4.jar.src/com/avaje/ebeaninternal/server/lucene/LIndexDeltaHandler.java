...
/*     */   
/*  74 */   private final Document document = new Document();
/*     */   
...
/*     */     }
/*     */     
/* 130 */     ArrayList<Object> filterIdList = new ArrayList();
/*     */ 
/*     */ 
/*     */     
/* 134 */     for (int i = 0; i < updateIds.size(); i++) {
/* 135 */       Serializable id = updateIds.get(i);
...
/* 146 */       for (int j = 0; j < list.size(); j++) {
/* 147 */         Object bean = list.get(j);
/*     */         try {
...
/* 189 */       Serializable id = deleteIds.get(i);
...
/* 209 */         BeanDelta deltaBean = this.deltaBeans.get(i);
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lucene\LIndexDeltaHandler.class
