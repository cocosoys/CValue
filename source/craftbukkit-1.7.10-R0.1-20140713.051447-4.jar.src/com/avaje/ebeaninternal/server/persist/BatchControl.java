...
/*     */ 
/*     */   
/*  66 */   private final BatchedPstmtHolder pstmtHolder = new BatchedPstmtHolder();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 108 */     this.batchFlushOnMixed = flushBatchOnMixed;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 221 */     return (this.beanControl.isEmpty() && this.pstmtHolder.isEmpty());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     this.pstmtHolder.flush(this.getGeneratedKeys);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 236 */       PersistRequest request = list.get(i);
...
/* 262 */       this.transaction.logInternal("BatchControl flush " + Arrays.toString((Object[])bsArray));
/*     */     }
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\persist\BatchControl.class
