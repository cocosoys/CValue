...
/* 45 */     return "BindableAssocOne " + this.assocOne;
/*    */   }
/*    */   
/*    */   public void addChanged(PersistRequestBean<?> request, List<Bindable> list) {
/* 49 */     if (request.hasChanged((BeanProperty)this.assocOne)) {
/* 50 */       list.add(this);
/*    */     }
/*    */   }
/*    */   
...
/* 59 */     if (checkIncludes && !request.isIncluded((BeanProperty)this.assocOne)) {
/*    */       return;
/*    */     }
...
/* 69 */     if (checkIncludes && !request.isIncludedWhere((BeanProperty)this.assocOne)) {
/*    */       return;
/*    */     }
...
/* 77 */     if (checkIncludes && !request.isIncluded((BeanProperty)this.assocOne)) {
/*    */       return;
/*    */     }
...
/* 84 */     if (checkIncludes && !request.isIncludedWhere((BeanProperty)this.assocOne)) {
/*    */       return;
/*    */     }
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\persist\dmlbind\BindableAssocOne.class
