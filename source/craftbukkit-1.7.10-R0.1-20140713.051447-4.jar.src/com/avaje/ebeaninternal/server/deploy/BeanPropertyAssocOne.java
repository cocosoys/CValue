...
/*  81 */     this(owner, (BeanDescriptor<?>)null, deploy);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  90 */     super(owner, descriptor, (DeployBeanPropertyAssoc<T>)deploy);
/*     */     
...
/*     */       } 
/* 105 */       this.embeddedPropsMap = new HashMap<String, BeanProperty>();
...
/* 143 */       BeanProperty embProp = this.embeddedPropsMap.get(remainder);
/* 144 */       if (embProp == null) {
...
/*     */       }
/* 151 */       chain.add(this);
/* 152 */       return (ElPropertyValue)chain.add(embProp).build();
/*     */     } 
/*     */     
...
/* 160 */     return encrypted ? this.elPlaceHolderEncrypted : this.elPlaceHolder;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void copyProperty(Object sourceBean, Object destBean, CopyContext ctx, int maxDepth) {
/* 166 */     this.localHelp.copyProperty(sourceBean, destBean, ctx, maxDepth);
/*     */   }
/*     */   
...
/* 346 */     return this.oneToOneExported;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 353 */     return this.embeddedVersion;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 360 */     return this.importedPrimaryKey;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 376 */     return this.targetDescriptor.getIdBinder().getIdValues(bean);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 383 */     return this.targetDescriptor.getIdBinder().getAssocOneIdExpr(prefix, operator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 391 */     return this.targetDescriptor.getIdBinder().getIdInValueExpr(size);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 399 */     return this.targetDescriptor.getIdBinder().getAssocIdInExpr(prefix);
/*     */   }
/*     */ 
/*     */   
...
/* 418 */     return getTargetDescriptor().createVanillaBean();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 425 */     return this.targetDescriptor.createEntityBean();
/*     */   }
/*     */   
...
/*     */     } 
/*     */     
/* 498 */     return list.<ExportedProperty>toArray(new ExportedProperty[list.size()]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 554 */     return this.localHelp.read(ctx);
/*     */   }
/*     */ 
/*     */   
/*     */   public void loadIgnore(DbReadContext ctx) {
/* 559 */     this.localHelp.loadIgnore(ctx);
/*     */   }
/*     */ 
/*     */   
...
/* 573 */     if (embedded)
/* 574 */       return new Embedded(); 
/* 575 */     if (oneToOneExported) {
/* 576 */       return new ReferenceExported();
/*     */     }
...
/*     */       } 
/*     */     } abstract void copyProperty(Object param1Object1, Object param1Object2, CopyContext param1CopyContext, int param1Int); abstract void loadIgnore(DbReadContext param1DbReadContext);
...
/*     */   private final class Embedded extends LocalHelp { void copyProperty(Object sourceBean, Object destBean, CopyContext ctx, int maxDepth) {
...
/* 697 */       copy(sourceBean, destBean, ctx, maxDepth);
/*     */     }
/*     */     
/*     */     void loadIgnore(DbReadContext ctx) {
...
/*     */     
/*     */     void copyProperty(Object sourceBean, Object destBean, CopyContext ctx, int maxDepth) {
/* 836 */       copy(sourceBean, destBean, ctx, maxDepth);
/*     */     }
/*     */ 
/*     */     
/*     */     void loadIgnore(DbReadContext ctx) {
/* 841 */       BeanPropertyAssocOne.this.targetDescriptor.getIdBinder().loadIgnore(ctx);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 940 */     T assocBean = this.targetDescriptor.jsonReadBean(ctx, this.name);
/* 941 */     setValue(bean, assocBean);
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\deploy\BeanPropertyAssocOne.class
