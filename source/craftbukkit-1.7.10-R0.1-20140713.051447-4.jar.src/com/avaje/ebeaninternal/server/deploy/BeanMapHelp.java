...
/* 108 */       return null;
/*     */     }
/* 110 */     Map<Object, Object> m = ctx.isVanillaMode() ? new LinkedHashMap<Object, Object>() : (Map<Object, Object>)new BeanMap();
/*     */     
...
/* 143 */     return vanilla ? new LinkedHashMap<Object, Object>() : new BeanMap();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 158 */     return (BeanCollection<T>)new BeanMap(this.loader, parentBean, propertyName);
/*     */   }
/*     */ 
/*     */   
...
/* 183 */     refresh((BeanCollection<?>)newBeanMap, parentBean);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\deploy\BeanMapHelp.class
