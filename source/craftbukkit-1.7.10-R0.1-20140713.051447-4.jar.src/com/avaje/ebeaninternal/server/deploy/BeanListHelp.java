...
/*     */       }
/*  53 */       return (BeanCollectionAdd)bl;
/*  54 */     }  if (bc instanceof List) {
/*  55 */       return new VanillaAdd((List)bc);
/*     */     }
/*     */     
...
/*  73 */       this.list.add(bean);
/*     */     }
/*     */   }
/*     */   
/*     */   public Iterator<?> getIterator(Object collection) {
/*  78 */     return ((List)collection).iterator();
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/*  87 */     List<T> l = ctx.isVanillaMode() ? new ArrayList<T>() : (List<T>)new BeanList();
/*     */     
...
/* 106 */       l.add((T)destDetail);
/*     */     } 
/* 108 */     return l;
/*     */   }
/*     */   
/*     */   public Object createEmpty(boolean vanilla) {
/* 112 */     return vanilla ? new ArrayList() : new BeanList();
/*     */   }
/*     */ 
/*     */   
/*     */   public BeanCollection<T> createReference(Object parentBean, String propertyName) {
/* 117 */     return (BeanCollection<T>)new BeanList(this.loader, parentBean, propertyName);
/*     */   }
/*     */ 
/*     */   
...
/* 141 */     refresh((BeanCollection<?>)newBeanList, parentBean);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\deploy\BeanListHelp.class
