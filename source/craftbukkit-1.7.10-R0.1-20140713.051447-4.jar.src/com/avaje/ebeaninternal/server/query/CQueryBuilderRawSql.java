...
/*  45 */     if (!rsql.isParsed()) {
/*  46 */       String str = rsql.getUnparsedSql();
/*  47 */       BindParams bindParams = request.getQuery().getBindParams();
/*  48 */       if (bindParams != null && bindParams.requiresNamedParamsPrepare())
/*     */       {
/*  50 */         str = BindParamsParser.parse(bindParams, str);
/*     */       }
/*     */       
/*  53 */       return new SqlLimitResponse(str, false);
/*     */     } 
/*     */     
...
/*     */     {
/*  64 */       return this.sqlLimiter.limit((SqlLimitRequest)new OrmQueryLimitRequest(sql, orderBy, query));
/*     */     }
/*     */ 
/*     */     
/*  68 */     sql = "select " + sql;
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\query\CQueryBuilderRawSql.class
