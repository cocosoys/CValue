...
/*  53 */     this.queryEngine = queryEngine;
/*     */   }
/*     */ 
/*     */   
/*     */   public <T> int findRowCount(OrmQueryRequest<T> request) {
/*  58 */     return this.queryEngine.findRowCount(request);
/*     */   }
/*     */ 
/*     */   
/*     */   public <T> BeanIdList findIds(OrmQueryRequest<T> request) {
/*  63 */     return this.queryEngine.findIds(request);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 100 */     if (finder != null) {
/*     */       
/* 102 */       result = finder.findMany((BeanQueryRequest)request);
/*     */     } else {
...
/* 151 */     if (finder != null) {
/* 152 */       result = (T)finder.find((BeanQueryRequest)request);
/*     */     } else {
/* 154 */       result = this.queryEngine.find(request);
/*     */     } 
/*     */     
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\query\DefaultOrmQueryEngine.class
