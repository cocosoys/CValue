...
/* 102 */       this.request.setLuceneOrmQueryRequest(new LuceneOrmQueryRequest((Query)q, luceneSort, "MatchAllDocs", sortDesc));
/* 103 */       return true;
/*     */     } 
/*     */     
...
/*     */     
/*     */     try {
/* 113 */       DefaultExpressionRequest whereReq = new DefaultExpressionRequest((SpiOrmQueryRequest)this.request, luceneIndex);
/* 114 */       SpiLuceneExpr luceneExpr = whereExp.createLuceneExpr((SpiExpressionRequest)whereReq, SpiLuceneExpr.ExprOccur.MUST);
/*     */       
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\query\CQueryPredicatesLuceneResolve.class
