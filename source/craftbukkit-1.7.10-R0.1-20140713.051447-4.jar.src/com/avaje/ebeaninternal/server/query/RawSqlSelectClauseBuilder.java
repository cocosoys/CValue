...
/*     */         
/*  92 */         SqlLimitResponse limitSql = this.dbQueryLimiter.limit((SqlLimitRequest)new OrmQueryLimitRequest(sql, orderBy, query));
...
/* 105 */       CQuery<T> compiledQuery = new CQuery<T>(request, predicates, queryPlan);
/*     */       
/* 107 */       return compiledQuery;
/*     */     }
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\query\RawSqlSelectClauseBuilder.class
