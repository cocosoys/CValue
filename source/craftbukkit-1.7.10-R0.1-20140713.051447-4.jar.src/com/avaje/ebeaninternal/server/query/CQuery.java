...
/*     */ 
/*     */   
/* 244 */   private final HashMap<String, ReferenceOptions> referenceOptionsMap = new HashMap<String, ReferenceOptions>();
/*     */ 
/*     */   
...
/*     */     else {
/*     */       
/* 304 */       this.persistenceContext = (PersistenceContext)new DefaultPersistenceContext();
/*     */     } 
/*     */     
...
/* 311 */     this.collection = (this.help != null) ? (BeanCollection<T>)this.help.createEmpty(false) : null;
/*     */   }
/*     */   
...
/* 340 */     return this.dataReader;
/*     */   }
/*     */   
/*     */   public SpiQuery.Mode getQueryMode() {
/* 344 */     return this.queryMode;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 351 */     return this.request.isVanillaMode();
/*     */   }
/*     */   
/*     */   public CQueryPredicates getPredicates() {
/* 355 */     return this.predicates;
/*     */   }
/*     */   
/*     */   public LoadContext getGraphContext() {
/* 359 */     return this.request.getGraphContext();
/*     */   }
/*     */   
/*     */   public SpiOrmQueryRequest<?> getQueryRequest() {
/* 363 */     return (SpiOrmQueryRequest<?>)this.request;
/*     */   }
/*     */   
/*     */   public void cancel() {
...
/* 437 */       logger.log(Level.SEVERE, (String)null, e);
/*     */     } 
/*     */     try {
...
/* 445 */       logger.log(Level.SEVERE, (String)null, e);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 458 */     ReferenceOptions opt = this.referenceOptionsMap.get(beanPropName);
/* 459 */     if (opt == null) {
...
/* 479 */     return this.persistenceContext;
/*     */   }
/*     */   
...
/* 501 */     this.loadedManyBean = manyValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 567 */     return this.executionTimeMicros;
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 651 */       ((BeanCollection)this.currentDetailCollection).setFilterMany((ExpressionList)this.filterMany);
/*     */     }
/*     */ 
/*     */     
...
/* 691 */       logger.log(Level.SEVERE, (String)null, e);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 697 */     if (bufferSize > 0) {
/* 698 */       return new CQueryIteratorWithBuffer<T>(this, request, bufferSize);
/*     */     }
/*     */     
/* 701 */     return new CQueryIteratorSimple<T>(this, request);
/*     */   }
/*     */ 
/*     */   
...
/* 751 */     return this.hasHitBackgroundFetchAfter;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 787 */     return this.sqlTree.getSummary();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 795 */     return this.sqlTree;
/*     */   }
/*     */   
/*     */   public String getBindLog() {
/* 799 */     return this.bindLog;
/*     */   }
/*     */   
/*     */   public SpiTransaction getTransaction() {
/* 803 */     return this.request.getTransaction();
/*     */   }
/*     */   
/*     */   public String getBeanType() {
/* 807 */     return this.desc.getFullName();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 829 */     return createPersistenceException(e, getTransaction(), this.bindLog, this.sql);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 862 */     return (this.autoFetchProfiling && this.query.isUsageProfiling());
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 873 */     String path = this.currentPathMap.get(propertyName);
/* 874 */     if (path != null) {
/* 875 */       return path;
/*     */     }
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\query\CQuery.class
