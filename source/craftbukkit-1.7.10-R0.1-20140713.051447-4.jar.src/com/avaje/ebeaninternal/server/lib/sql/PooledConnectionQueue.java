...
/* 346 */     ReentrantLock lock = this.lock;
/* 347 */     lock.lock();
/*     */     try {
...
/* 375 */     ReentrantLock lock = this.lock;
/* 376 */     lock.lock();
/*     */     try {
...
/* 423 */       PooledConnection pc = it.next();
...
/* 450 */     ReentrantLock lock = this.lock;
/* 451 */     lock.lock();
/*     */     try {
...
/* 485 */         PooledConnection pc = copy.get(i);
...
/*     */       
/* 519 */       logger.log(Level.SEVERE, (String)null, ex);
/*     */     } 
/*     */   }
/*     */   
...
/* 526 */       String s = Arrays.toString((Object[])stackTrace);
...
/* 560 */     return getBusyConnectionInformation(false);
/*     */   }
/*     */   
/*     */   public void dumpBusyConnectionInformation() {
/* 564 */     getBusyConnectionInformation(true);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 572 */     ReentrantLock lock = this.lock;
/* 573 */     lock.lock();
/*     */     
/*     */     try {
/* 576 */       if (toLogger) {
...
/* 584 */         PooledConnection pc = copy.get(i);
/* 585 */         if (toLogger) {
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lib\sql\PooledConnectionQueue.class
