...
/*     */ 
/*     */   
/*  49 */   private final Hashtable<String, DataSourcePool> dsMap = new Hashtable<String, DataSourcePool>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*  81 */     this.alertlistener = createAlertListener();
/*     */ 
/*     */     
/*  84 */     this.dbUpFreqInSecs = GlobalProperties.getInt("datasource.heartbeatfreq", 30);
/*  85 */     this.dbDownFreqInSecs = GlobalProperties.getInt("datasource.deadbeatfreq", 10);
/*  86 */     this.dbChecker = new BackgroundRunnable(new Checker(), this.dbUpFreqInSecs);
/*     */     
/*     */     try {
/*  89 */       BackgroundThread.add(this.dbChecker);
/*     */     }
/*  91 */     catch (Exception e) {
/*  92 */       logger.log(Level.SEVERE, (String)null, e);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*     */         try {
/* 166 */           DataSourcePool ds = it.next();
/* 167 */           ds.shutdown();
/*     */         }
/* 169 */         catch (DataSourceException e) {
/*     */           
/* 171 */           logger.log(Level.SEVERE, (String)null, e);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* 193 */     return getDataSource(name, null);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 204 */       DataSourcePool pool = this.dsMap.get(name);
/* 205 */       if (pool == null) {
...
/*     */     
/*     */     public void run() {
/* 240 */       DataSourceManager.this.checkDataSource();
/*     */     }
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lib\sql\DataSourceManager.class
