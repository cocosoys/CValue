...
/*     */   
/*  41 */   static final Vector<Runnable> runnables = new Vector<Runnable>();
/*     */   
...
/*     */   static {
/*  53 */     register();
/*  54 */   } static boolean whyShutdown = GlobalProperties.getBoolean("debug.shutdown.why", false);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 139 */           logger.log(Level.WARNING, "Stacktrace showing why shutdown was fired", throwable);
/*     */         } 
/*     */       }
/*     */       
/* 143 */       stopping = true;
...
/* 157 */           logger.log(Level.SEVERE, (String)null, exception);
/*     */         } 
/*     */       }
/*     */ 
/*     */ 
...
/*     */         try {
/* 166 */           Runnable r = e.nextElement();
/* 167 */           r.run();
/* 168 */         } catch (Exception ex) {
/* 169 */           logger.log(Level.SEVERE, (String)null, ex);
...
/*     */         try {
/* 190 */           logger.log(Level.SEVERE, (String)null, ex);
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\lib\ShutdownManager.class
