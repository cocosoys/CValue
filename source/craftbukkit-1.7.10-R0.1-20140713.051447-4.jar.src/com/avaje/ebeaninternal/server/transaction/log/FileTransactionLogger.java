...
/*     */ 
/*     */   
/*  73 */   private final ConcurrentLinkedQueue<TransactionLogBuffer> logBufferQueue = new ConcurrentLinkedQueue<TransactionLogBuffer>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  90 */   private final String deliminator = ", ";
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 135 */     this(threadName, dir, logFileName, "log", maxBytesPerFile);
/*     */   }
/*     */   
...
/*     */   
/*     */   public void start() {
/* 166 */     this.logWriterThread.start();
/*     */   }
/*     */ 
/*     */   
...
/* 210 */           missCount++;
/*     */         } else {
/* 212 */           TransactionLogBuffer buffer = this.logBufferQueue.remove();
/* 213 */           write(buffer);
/* 214 */           missCount = 0;
/*     */         } 
/*     */       } 
...
/* 228 */     this.logBufferQueue.add(logBuffer);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 249 */       TransactionLogBuffer.LogEntry msg = messages.get(i);
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\transaction\log\FileTransactionLogger.class
