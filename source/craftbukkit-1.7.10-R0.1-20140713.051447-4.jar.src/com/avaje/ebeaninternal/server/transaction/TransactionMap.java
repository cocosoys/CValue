...
/*     */ {
/*  37 */   HashMap<String, State> map = new HashMap<String, State>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  44 */     State state = this.map.get(serverName);
/*  45 */     if (state == null) {
/*  46 */       state = new State();
...
/* 106 */       this.transaction = trans;
/*     */     }
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\transaction\TransactionMap.class
