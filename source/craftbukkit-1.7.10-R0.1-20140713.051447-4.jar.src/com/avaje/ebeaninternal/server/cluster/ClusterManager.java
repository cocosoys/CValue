...
/*     */   
/*  42 */   private final ConcurrentHashMap<String, EbeanServer> serverMap = new ConcurrentHashMap<String, EbeanServer>();
/*     */   
...
/*  74 */           this.broadcast = (ClusterBroadcast)new McastClusterManager();
/*     */         }
/*  76 */         else if ("socket".equalsIgnoreCase(clusterType)) {
/*  77 */           this.broadcast = (ClusterBroadcast)new SocketClusterBroadcast();
/*     */         } else {
/*     */           
...
/* 125 */     return (this.broadcast != null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\cluster\ClusterManager.class
