...
/*  44 */   private int queryFetchBatch = -1;
/*     */ 
/*     */   
/*     */   private boolean queryFetchAll;
/*     */ 
/*     */   
/*  50 */   private int lazyFetchBatch = -1;
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 162 */     return (this.trimmedProperties == null || this.trimmedProperties.length() == 0 || "*".equals(this.trimmedProperties));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 175 */       this.filterMany = (SpiExpressionList)new FilterExpressionList(exprPath, filterEf, rootQuery);
/*     */       
...
/* 206 */     this.filterMany = filterMany;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 236 */         query.setFilterMany(this.path, (ExpressionList)this.filterMany);
/*     */       }
/*     */     } 
/*     */     
...
/* 243 */         OrmQueryProperties p = this.secondaryChildren.get(i);
/* 244 */         String path = p.getPath();
/* 245 */         path = path.substring(trimPath);
/* 246 */         query.fetch(path, p.getProperties(), p.getFetchConfig());
/* 247 */         query.setFilterMany(path, (ExpressionList)p.getFilterManyTrimPath(trimPath));
/*     */       } 
/*     */     } 
/*     */     
...
/* 270 */       query.setFilterMany(this.path, (ExpressionList)this.filterMany);
/*     */     }
...
/* 277 */         OrmQueryProperties p = this.secondaryChildren.get(i);
/* 278 */         String path = p.getPath();
/* 279 */         path = path.substring(trimlen);
/* 280 */         query.fetch(path, p.getProperties(), p.getFetchConfig());
/* 281 */         query.setFilterMany(path, (ExpressionList)p.getFilterManyTrimPath(trimlen));
/*     */       } 
/*     */     } 
/*     */     
...
/* 305 */       copy.included = new HashSet<String>(this.included);
/*     */     }
/* 307 */     if (this.includedBeanJoin != null) {
/* 308 */       copy.includedBeanJoin = new HashSet<String>(this.includedBeanJoin);
/*     */     }
/* 310 */     return copy;
/*     */   }
/*     */   
...
/* 336 */     return possibleChild.getPath().startsWith(this.path + ".");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 344 */       this.secondaryChildren = new ArrayList<OrmQueryProperties>();
/*     */     }
...
/* 394 */     return (this.properties != null || this.included != null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 417 */       this.includedBeanJoin = new HashSet<String>();
/*     */     }
/* 419 */     this.includedBeanJoin.add(propertyName);
/*     */   }
/*     */   
/*     */   public boolean allProperties() {
/* 423 */     return (this.included == null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 446 */       this.secondaryQueryJoins = new HashSet<String>(4);
/*     */     }
...
/* 463 */       return new LinkedHashSet<String>(this.included);
/*     */     }
/*     */     
...
/* 523 */     return (!isQueryFetch() && !isLazyFetch());
/*     */   }
/*     */   
/*     */   public boolean isQueryFetch() {
/* 527 */     return (this.queryFetchBatch > -1);
/*     */   }
/*     */   
/*     */   public int getQueryFetchBatch() {
/* 531 */     return this.queryFetchBatch;
/*     */   }
/*     */   
/*     */   public boolean isQueryFetchAll() {
/* 535 */     return this.queryFetchAll;
/*     */   }
/*     */   
/*     */   public boolean isLazyFetch() {
/* 539 */     return (this.lazyFetchBatch > -1);
/*     */   }
/*     */   
/*     */   public int getLazyFetchBatch() {
/* 543 */     return this.lazyFetchBatch;
/*     */   }
/*     */   
/*     */   public boolean isReadOnly() {
/* 547 */     return this.readOnly;
/*     */   }
/*     */   
/*     */   public boolean isCache() {
/* 551 */     return this.cache;
/*     */   }
/*     */   
/*     */   public String getParentPath() {
/* 555 */     return this.parentPath;
/*     */   }
/*     */   
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\querydefn\OrmQueryProperties.class
