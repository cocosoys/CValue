...
/*     */       } 
/*     */     }
/*  97 */     return (Query)NumericRangeQuery.newIntRange(this.propertyName, min, max, this.minInclusive, this.maxInclusive);
/*     */   }
/*     */ 
/*     */   
...
/* 109 */         max = Long.valueOf(Long.MAX_VALUE);
/* 110 */       } else if (SimpleExpression.Op.LT.equals(this.op) || SimpleExpression.Op.LT_EQ.equals(this.op)) {
/* 111 */         min = Long.valueOf(Long.MIN_VALUE);
/*     */       } 
/*     */     }
/* 114 */     return (Query)NumericRangeQuery.newLongRange(this.propertyName, min, max, this.minInclusive, this.maxInclusive);
/*     */   }
/*     */ 
/*     */   
...
/*     */       } 
/*     */     }
/* 131 */     return (Query)NumericRangeQuery.newFloatRange(this.propertyName, min, max, this.minInclusive, this.maxInclusive);
/*     */   }
/*     */ 
/*     */   
...
/*     */       } 
/*     */     }
/* 148 */     return (Query)NumericRangeQuery.newDoubleRange(this.propertyName, min, max, this.minInclusive, this.maxInclusive);
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\expression\LLuceneRangeExpression.class
