...
/*     */ {
/*  28 */   protected final ArrayList<WeakReference<T>> list = new ArrayList<WeakReference<T>>();
/*     */ 
/*     */ 
/*     */   
...
/*  39 */       this.list.add(new WeakReference<T>(e));
/*  40 */       return i;
/*     */     } 
/*     */   }
/*     */ 
...
/*     */       
/*  89 */       if (removeFromTop) {
/*  90 */         weakEntry = this.list.remove(relativePos);
...
/*     */           break;
/*     */         }
/*  97 */         weakEntry = this.list.get(relativePos);
/*  98 */         this.list.set(relativePos, null);
/*  99 */         relativePos++;
/*     */       } 
/* 101 */       T ebi = (weakEntry == null) ? null : weakEntry.get();
/*     */       
/* 103 */       if (ebi != null) {
/* 104 */         batch.add(ebi);
/* 105 */         count++;
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\loadcontext\DLoadWeakList.class
