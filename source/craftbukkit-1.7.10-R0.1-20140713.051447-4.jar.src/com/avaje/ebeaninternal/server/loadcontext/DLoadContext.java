...
/*  54 */   private final Map<String, DLoadBeanContext> beanMap = new HashMap<String, DLoadBeanContext>();
/*  55 */   private final Map<String, DLoadManyContext> manyMap = new HashMap<String, DLoadManyContext>();
/*     */ 
/*     */   
...
/*     */   
/*  72 */   private Map<String, ObjectGraphNode> nodePathMap = new HashMap<String, ObjectGraphNode>();
/*     */   
...
/* 122 */         OrmQueryProperties properties = this.secQuery.get(i);
/*     */         
...
/* 160 */         OrmQueryProperties props = this.secQuery.get(i);
...
/* 168 */         OrmQueryProperties lazyProps = lazyQueries.get(i);
...
/* 190 */     ObjectGraphNode node = this.nodePathMap.get(path);
/* 191 */     if (node == null) {
...
/* 212 */     return this.useAutofetchManager;
/*     */   }
/*     */   
/*     */   public String getRelativePath() {
/* 216 */     return this.relativePath;
/*     */   }
/*     */   
/*     */   protected SpiEbeanServer getEbeanServer() {
/* 220 */     return this.ebeanServer;
/*     */   }
/*     */   
/*     */   public int getParentState() {
/* 224 */     return this.parentState;
/*     */   }
/*     */   
/*     */   public PersistenceContext getPersistenceContext() {
/* 228 */     return this.persistenceContext;
/*     */   }
/*     */   
/*     */   public void setPersistenceContext(PersistenceContext persistenceContext) {
/* 232 */     this.persistenceContext = persistenceContext;
/*     */   }
/*     */   
/*     */   public void register(String path, EntityBeanIntercept ebi) {
/* 236 */     getBeanContext(path).register(ebi);
/*     */   }
/*     */   
/*     */   public void register(String path, BeanCollection<?> bc) {
/* 240 */     getManyContext(path).register(bc);
/*     */   }
/*     */   
...
/*     */     }
/* 247 */     DLoadBeanContext beanContext = this.beanMap.get(path);
...
/*     */     }
/* 274 */     DLoadManyContext ctx = this.manyMap.get(path);
/* 275 */     if (ctx == null) {
...
/* 300 */     return desc.getBeanPropertyFromPath(path);
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\loadcontext\DLoadContext.class
