...
/*  72 */     return (valueAdapter == null) ? dfltValueAdapter : valueAdapter;
/*     */   }
/*     */   
/*     */   public JsonValueAdapter getValueAdapter() {
/*  76 */     return this.valueAdapter;
/*     */   }
/*     */   
/*     */   public char getToken() {
/*  80 */     return this.tokenStart;
/*     */   }
/*     */   
/*     */   public String getTokenKey() {
/*  84 */     return this.tokenKey;
/*     */   }
/*     */   
/*     */   public boolean isTokenKey() {
/*  88 */     return ('"' == this.tokenStart);
/*     */   }
/*     */   
/*     */   public boolean isTokenObjectEnd() {
/*  92 */     return ('}' == this.tokenStart);
/*     */   }
/*     */   
...
/*     */     while (true) {
/* 277 */       char c1 = this.src.nextChar("EOF reading key");
/* 278 */       if ('"' == c1) {
...
/* 295 */     this.src.ignoreWhiteSpace();
/*     */   }
/*     */   
/*     */   public void pushBean(Object bean, String path, BeanDescriptor<?> beanDescriptor) {
/* 299 */     this.currentState = new ReadBeanState(bean, beanDescriptor);
...
/* 309 */       JsonReadBeanVisitor<?> beanVisitor = this.visitorMap.get(path);
/* 310 */       if (beanVisitor != null) {
/* 311 */         this.currentState.visit((JsonReadBeanVisitor)beanVisitor);
/*     */       }
...
/* 327 */     this.currentState.setLoaded(propertyName);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 365 */         this.loadedProps = new HashSet<String>();
/*     */       } else {
/* 367 */         this.ebi = null;
...
/* 372 */       return this.bean.getClass().getSimpleName() + " loaded:" + this.loadedProps;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 386 */         this.unmapped = new LinkedHashMap<String, JsonElement>();
/*     */       }
...
/* 417 */       return this.bean;
/*     */     }
/*     */   }
/*     */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\text\json\ReadJsonContext.class
