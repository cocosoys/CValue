...
/*  43 */   private final ArrayStack<Object> parentBeans = new ArrayStack();
/*     */ 
/*     */   
...
/* 115 */     return (valueAdapter == null) ? dfltValueAdapter : valueAdapter;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */       return this.visitorMap.get(path);
/*     */     } 
/* 135 */     return null;
/*     */   }
/*     */   
/*     */   public String getJson() {
/* 139 */     return this.buffer.toString();
/*     */   }
/*     */ 
/*     */   
...
/* 178 */     this.buffer.append(",");
/*     */   }
/*     */   
/*     */   public void addDepthOffset(int offset) {
/* 182 */     this.depthOffset += offset;
/*     */   }
/*     */   
...
/* 246 */     appendKeyWithComma(key, true);
/*     */   }
/*     */   
...
/* 275 */     this.buffer.append("null");
/*     */   }
/*     */   
/*     */   public JsonValueAdapter getValueAdapter() {
/* 279 */     return this.valueAdapter;
/*     */   }
/*     */   
/*     */   public String toString() {
/* 283 */     return this.buffer.toString();
/*     */   }
/*     */   
/*     */   public void popParentBean() {
/* 287 */     this.parentBeans.pop();
/*     */   }
/*     */   
/*     */   public void pushParentBean(Object parentBean) {
/* 291 */     this.parentBeans.push(parentBean);
/*     */   }
/*     */   
...
/* 320 */     this.beanState = previousState;
/*     */   }
/*     */   
/*     */   public boolean isReferenceBean() {
/* 324 */     return this.beanState.isReferenceBean();
/*     */   }
/*     */   
/*     */   public boolean includedProp(String name) {
/* 328 */     return this.beanState.includedProp(name);
/*     */   }
/*     */   
/*     */   public Set<String> getLoadedProps() {
/* 332 */     return this.beanState.getLoadedProps();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebeaninternal\server\text\json\WriteJsonContext.class
