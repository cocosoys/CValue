...
/*  33 */   private int fromPos = -1;
/*  34 */   private int wherePos = -1;
/*  35 */   private int groupByPos = -1;
/*  36 */   private int havingPos = -1;
/*  37 */   private int orderByPos = -1;
/*     */   
/*     */   private boolean whereExprAnd;
/*  40 */   private int whereExprPos = -1;
/*     */   private boolean havingExprAnd;
/*  42 */   private int havingExprPos = -1;
/*     */   
/*     */   public static RawSql.Sql parse(String sql) {
/*  45 */     return (new DRawSqlParser(sql)).parse();
/*     */   }
/*     */ 
/*     */   
...
/* 163 */     return this.sql.substring(0, this.fromPos - 1);
/*     */   }
/*     */   
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebean\DRawSqlParser.class
