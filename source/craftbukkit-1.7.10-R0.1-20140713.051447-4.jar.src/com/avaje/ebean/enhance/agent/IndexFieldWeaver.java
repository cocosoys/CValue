...
/*  78 */       FieldMeta fieldMeta = fields.get(i);
...
/*     */     
/* 147 */     for (int j = 0; j < fields.size(); j++) {
/*     */       
/* 149 */       FieldMeta fieldMeta = fields.get(j);
/*     */       
/* 151 */       mv.visitLabel(switchLabels[j]);
/* 152 */       mv.visitLineNumber(1, switchLabels[j]);
...
/*     */     
/* 227 */     for (int j = 0; j < fields.size(); j++) {
/* 228 */       FieldMeta fieldMeta = fields.get(j);
/*     */       
/* 230 */       mv.visitLabel(switchLabels[j]);
/* 231 */       mv.visitLineNumber(1, switchLabels[j]);
...
/*     */       
/* 293 */       FieldMeta fieldMeta = fields.get(i);
...
/* 343 */       FieldMeta fieldMeta = fields.get(i);
/* 344 */       mv.visitInsn(89);
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebean\enhance\agent\IndexFieldWeaver.class
