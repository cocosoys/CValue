...
/* 69 */         String str = "Expecting AS keyword parsing column " + colInfo;
/* 70 */         throw new PersistenceException(str);
/*    */       } 
/* 72 */       return new RawSql.ColumnMapping.Column(this.indexPos++, split[0], split[2]);
/*    */     } 
/*    */     
/* 75 */     String msg = "Expecting Max 3 words parsing column " + colInfo + ". Got " + Arrays.toString((Object[])split);
...
/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\craftbukkit-1.7.10-R0.1-20140713.051447-4.jar!\com\avaje\ebean\DRawSqlColumnsParser.class
