...
/* 66 */       shift++;
/*    */     } 
/* 68 */     return 32768 * shift + eval_table(log_2_table, x - 32768);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 77 */     int y = eval_table(exp_2_table, x & 0x7FFF) << 15;
/* 78 */     return y >> 15 - (x >> 15);
/*    */   }
/*    */ 
/*    */   
/*    */   private static int eval_table(int[] table, int x) {
/* 83 */     int table_idx = x >> 8;
/* 84 */     int table_frac = x & 0xFF;
/* 85 */     int c = table[table_idx];
/* 86 */     int m = table[table_idx + 1] - c;
/* 87 */     int y = (m * table_frac >> 8) + c;
/* 88 */     return y >> 0;
/*    */   }
/*    */ }


/* Location:              D:\WorkTools\Project\Minecraft\plugins\craftbukkit\1.7.10\CValue\libs\core\forgeSrc-1.7.10-10.13.4.1614-1.7.10.jar!\ibxm\LogTable.class
