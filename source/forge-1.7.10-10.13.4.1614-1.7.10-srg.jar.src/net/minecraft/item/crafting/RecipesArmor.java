...
/*  7 */   private String[][] field_77611_a = new String[][] { { "XXX", "X X" }, { "X X", "XXX", "XXX" }, { "XXX", "X X", "X X" }, { "X X", "X X" } };
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 40 */     for (byte b = 0; b < (this.field_77610_b[0]).length; b++) {
/*    */       
/* 42 */       Object object = this.field_77610_b[0][b];
/*    */       
/* 44 */       for (byte b1 = 0; b1 < this.field_77610_b.length - 1; b1++) {
/* 45 */         Item item = (Item)this.field_77610_b[b1 + 1][b];
/*    */         
/* 47 */         p_77609_1_.func_92103_a(new ItemStack(item), new Object[] { this.field_77611_a[b1], Character.valueOf('X'), object });
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
