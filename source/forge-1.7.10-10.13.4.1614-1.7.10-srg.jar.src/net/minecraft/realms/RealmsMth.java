...
/*  10 */     return MathHelper.func_76126_a(p_sin_0_);
/*     */   }
...
/*  14 */     return MathHelper.func_82716_a(p_nextDouble_0_, p_nextDouble_1_, p_nextDouble_3_);
/*     */   }
/*     */   
/*     */   public static int ceil(float p_ceil_0_) {
/*  18 */     return MathHelper.func_76123_f(p_ceil_0_);
/*     */   }
/*     */   
/*     */   public static int floor(double p_floor_0_) {
/*  22 */     return MathHelper.func_76128_c(p_floor_0_);
/*     */   }
/*     */   
/*     */   public static int intFloorDiv(int p_intFloorDiv_0_, int p_intFloorDiv_1_) {
/*  26 */     return MathHelper.func_76137_a(p_intFloorDiv_0_, p_intFloorDiv_1_);
/*     */   }
/*     */   
/*     */   public static float abs(float p_abs_0_) {
/*  30 */     return MathHelper.func_76135_e(p_abs_0_);
/*     */   }
/*     */   
/*     */   public static int clamp(int p_clamp_0_, int p_clamp_1_, int p_clamp_2_) {
/*  34 */     return MathHelper.func_76125_a(p_clamp_0_, p_clamp_1_, p_clamp_2_);
/*     */   }
/*     */   
/*     */   public static double clampedLerp(double p_clampedLerp_0_, double p_clampedLerp_2_, double p_clampedLerp_4_) {
/*  38 */     return MathHelper.func_151238_b(p_clampedLerp_0_, p_clampedLerp_2_, p_clampedLerp_4_);
/*     */   }
/*     */   
/*     */   public static int ceil(double p_ceil_0_) {
/*  42 */     return MathHelper.func_76143_f(p_ceil_0_);
/*     */   }
/*     */   
/*     */   public static boolean isEmpty(String p_isEmpty_0_) {
/*  46 */     return MathHelper.func_76139_a(p_isEmpty_0_);
/*     */   }
/*     */   
/*     */   public static long lfloor(double p_lfloor_0_) {
/*  50 */     return MathHelper.func_76124_d(p_lfloor_0_);
/*     */   }
/*     */   
/*     */   public static float sqrt(double p_sqrt_0_) {
/*  54 */     return MathHelper.func_76133_a(p_sqrt_0_);
/*     */   }
/*     */   
/*     */   public static double clamp(double p_clamp_0_, double p_clamp_2_, double p_clamp_4_) {
/*  58 */     return MathHelper.func_151237_a(p_clamp_0_, p_clamp_2_, p_clamp_4_);
/*     */   }
/*     */   
/*     */   public static int getInt(String p_getInt_0_, int p_getInt_1_) {
/*  62 */     return MathHelper.func_82715_a(p_getInt_0_, p_getInt_1_);
/*     */   }
/*     */   
/*     */   public static double getDouble(String p_getDouble_0_, double p_getDouble_1_) {
/*  66 */     return MathHelper.func_82712_a(p_getDouble_0_, p_getDouble_1_);
/*     */   }
/*     */   
/*     */   public static int log2(int p_log2_0_) {
/*  70 */     return MathHelper.func_151239_c(p_log2_0_);
/*     */   }
/*     */   
...
/*  78 */     return MathHelper.func_151236_b(p_smallestEncompassingPowerOfTwo_0_);
/*     */   }
/*     */   
/*     */   public static float sqrt(float p_sqrt_0_) {
/*  82 */     return MathHelper.func_76129_c(p_sqrt_0_);
/*     */   }
/*     */   
/*     */   public static float cos(float p_cos_0_) {
/*  86 */     return MathHelper.func_76134_b(p_cos_0_);
/*     */   }
/*     */   
/*     */   public static int getInt(String p_getInt_0_, int p_getInt_1_, int p_getInt_2_) {
/*  90 */     return MathHelper.func_82714_a(p_getInt_0_, p_getInt_1_, p_getInt_2_);
/*     */   }
/*     */   
/*     */   public static int fastFloor(double p_fastFloor_0_) {
/*  94 */     return MathHelper.func_76140_b(p_fastFloor_0_);
/*     */   }
/*     */   
/*     */   public static double asbMax(double p_asbMax_0_, double p_asbMax_2_) {
/*  98 */     return MathHelper.func_76132_a(p_asbMax_0_, p_asbMax_2_);
/*     */   }
/*     */   
/*     */   public static float nextFloat(Random p_nextFloat_0_, float p_nextFloat_1_, float p_nextFloat_2_) {
/* 102 */     return MathHelper.func_151240_a(p_nextFloat_0_, p_nextFloat_1_, p_nextFloat_2_);
/*     */   }
/*     */   
/*     */   public static double wrapDegrees(double p_wrapDegrees_0_) {
/* 106 */     return MathHelper.func_76138_g(p_wrapDegrees_0_);
/*     */   }
/*     */   
/*     */   public static float wrapDegrees(float p_wrapDegrees_0_) {
/* 110 */     return MathHelper.func_76142_g(p_wrapDegrees_0_);
/*     */   }
/*     */   
/*     */   public static float clamp(float p_clamp_0_, float p_clamp_1_, float p_clamp_2_) {
/* 114 */     return MathHelper.func_76131_a(p_clamp_0_, p_clamp_1_, p_clamp_2_);
/*     */   }
/*     */   
/*     */   public static double getDouble(String p_getDouble_0_, double p_getDouble_1_, double p_getDouble_3_) {
/* 118 */     return MathHelper.func_82713_a(p_getDouble_0_, p_getDouble_1_, p_getDouble_3_);
/*     */   }
/*     */   
/*     */   public static int roundUp(int p_roundUp_0_, int p_roundUp_1_) {
/* 122 */     return MathHelper.func_154354_b(p_roundUp_0_, p_roundUp_1_);
/*     */   }
/*     */   
/*     */   public static double average(long[] p_average_0_) {
/* 126 */     return MathHelper.func_76127_a(p_average_0_);
/*     */   }
/*     */   
/*     */   public static int floor(float p_floor_0_) {
/* 130 */     return MathHelper.func_76141_d(p_floor_0_);
/*     */   }
/*     */   
/*     */   public static int abs(int p_abs_0_) {
/* 134 */     return MathHelper.func_76130_a(p_abs_0_);
/*     */   }
/*     */   
/*     */   public static int nextInt(Random p_nextInt_0_, int p_nextInt_1_, int p_nextInt_2_) {
/* 138 */     return MathHelper.func_76136_a(p_nextInt_0_, p_nextInt_1_, p_nextInt_2_);
/*     */   }
/*     */ }
